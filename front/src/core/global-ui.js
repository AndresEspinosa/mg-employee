 ...
 * @return {Object}
 */
export const initializeGlobalUI = (store, environment) => {
    ...
    globalUI.getDashboardUrl = () => config.routes.find(
    ...
    if (!environment.isUnitTest) {
        globalUI.getImage = require.context('../styles/images', true);
    }
